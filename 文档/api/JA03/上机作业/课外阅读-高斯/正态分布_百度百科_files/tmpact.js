...
var show = 1; //是否展示，0是不展示，1是展示，2只在首页展示，3只在词条页展示
	...
	var linkSrc2 = 'http://baike.baidu.com/cms/s/banner/teleimenqin.png';//图片的地址 
	var linkHref2 = 'http://baike.baidu.com/view/1714445.htm';//图片的链接
	var linkText2 = '我是歌手中周笔畅弹奏的是什么琴';//鼠标滑过信息
	var isLink2 = true;
	var isFlash2 = false;
